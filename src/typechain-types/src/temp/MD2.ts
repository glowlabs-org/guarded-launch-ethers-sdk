...
export interface MD2Interface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "addToCurrentBucket"
      | "currentBucket"
      | "genesisTimestampInternal"
      | "getAmountForTokenAndInitIfNot"
      | "getBucketTracker"
      | "rawRewardInStorage"
      | "reward"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "genesisTimestampInternal",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getAmountForTokenAndInitIfNot",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "rawRewardInStorage",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
