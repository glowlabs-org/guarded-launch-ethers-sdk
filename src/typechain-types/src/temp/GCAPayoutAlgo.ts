...
export type CompensationIStruct = { shares: BigNumberish; agent: string };
...
export interface GCAPayoutAlgoInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "helpers"
      | "nextReward"
      | "nextRewardMockTimestamp"
      | "proposedCompensationPlans"
      | "removeGCA"
      | "rewardsPerSecondForAll"
  ...
  encodeFunctionData(
    functionFragment: "nextRewardMockTimestamp",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "proposedCompensationPlans",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "removeGCA", values: [string]): string;
  encodeFunctionData(
    functionFragment: "rewardsPerSecondForAll",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "submitCompensationPlan",
    values: [CompensationIStruct[]]
  ): string;
  encodeFunctionData(
...
export interface GCAPayoutAlgo extends BaseContract {
  ...
  functions: {
    ...
    proposedCompensationPlans(
      ...
      arg1: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber, string] & { shares: BigNumber; agent: string }>;
    ...
    submitCompensationPlan(
      compensationPlan: CompensationIStruct[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
