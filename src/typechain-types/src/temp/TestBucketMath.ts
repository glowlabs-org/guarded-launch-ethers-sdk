...
export interface TestBucketMathInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "BUCKET_LENGTH",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "BUCKET_VESTING_SHIFT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "VESTING_WEEK_LENGTH",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getBucketValue",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getCurrentBucket",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "lastUpdatedWeek",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalToDeduce",
    values: [BigNumberish]
  ): string;
