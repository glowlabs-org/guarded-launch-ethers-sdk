...
export interface MockMinerPoolAndGCAInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "checkWeightsForOverflow",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "currentWeekInternal",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "domainSeperatorOZ",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "domainSeperatorV4MainInternal",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getPushedWeights",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getUserBitmapForBucket",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "incrementSlashNonce",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "pushRequirementsHashMock",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "pushedWeights",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface MockMinerPoolAndGCA extends BaseContract {
  ...
  functions: {
    ...
    checkWeightsForOverflow(
      bucketId: BigNumberish,
      totalGlwWeight: BigNumberish,
      totalUsdcWeight: BigNumberish,
    ...
    getPushedWeights(
      bucketId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber, BigNumber] & { glw: BigNumber; usdc: BigNumber }>;
