...
export interface ImpactCatalystInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "commitGCC"
      | "commitUSDC"
      | "estimateGCCCommitImpactPower"
      | "estimateUSDCCommitImpactPower"
  ...
  encodeFunctionData(
    functionFragment: "UNISWAP_V2_PAIR",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "estimateGCCCommitImpactPower",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "estimateUSDCCommitImpactPower",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "findOptimalAmountToSwap",
    values: [BigNumberish, BigNumberish]
  ): string;
...
export interface ImpactCatalyst extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { expectedImpactPower: BigNumber }>;
    ...
    findOptimalAmountToSwap(
      amountTocommit: BigNumberish,
      totalReservesOfToken: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  };
  ...
  callStatic: {
    ...
    commitGCC(
      ...
      [BigNumber, BigNumber] & { usdcEffect: BigNumber; nominations: BigNumber }
    >;
