...
export interface VetoCouncilInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "MAX_COUNCIL_MEMBERS",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "VESTING_REWARDS_PER_SECOND_FOR_ALL",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "addAndRemoveCouncilMember",
    values: [string, string, boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "amountAlreadyWithdrawnFromPaymentNonce",
  ...
  encodeFunctionData(
    functionFragment: "memberStatus",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "numberOfCouncilMembers",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "paymentNonceTomembersHash",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "payoutData",
    values: [string, BigNumberish, string[]]
  ): string;
  encodeFunctionData(
    functionFragment: "pullGlowFromInflation",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "vetoCouncilMembers",
    values?: undefined
  ): string;
...
export type CouncilMemberPayoutEventFilter =
  TypedEventFilter<CouncilMemberPayoutEvent>;
...
export type VetoCouncilSeatsEditedEventFilter =
  TypedEventFilter<VetoCouncilSeatsEditedEvent>;
...
export interface VetoCouncil extends BaseContract {
  ...
  filters: {
    "CouncilMemberPayout(address,uint256,uint256)"(
      account?: string | null,
      amountNow?: null,
      amountToBeVested?: null
    ): CouncilMemberPayoutEventFilter;
    CouncilMemberPayout(
      account?: string | null,
      amountNow?: null,
      amountToBeVested?: null
    ...
    "PayoutClaimed(address,uint256,uint256)"(
      member?: string | null,
    ...
    "VetoCouncilSeatsEdited(address,address,bool)"(
      oldMember?: string | null,
      newMember?: string | null,
      slashOldMember?: null
    ): VetoCouncilSeatsEditedEventFilter;
