...
export interface TestGLOWInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DOMAIN_SEPARATOR" | "EARLY_LIQUIDITY_ADDRESS" | "EMERGENCY_COOLDOWN_PERIOD" | "GCA_AND_MINER_POOL_INFLATION_PER_SECOND" | "GENESIS_TIMESTAMP" | "GRANTS_TREASURY_INFLATION_PER_SECOND" | "MAX_UNSTAKES_BEFORE_EMERGENCY_COOLDOWN" | "USDG" | "VETO_COUNCIL_INFLATION_PER_SECOND" | "accountUnstakedPositionPointers" | "allowance" | "allowlistAddress" | "allowlistedContracts" | "approve" | "balanceOf" | "claimGLWFromGCAAndMinerPool" | "claimGLWFromGrantsTreasury" | "claimGLWFromVetoCouncil" | "claimUnstakedTokens" | "decimals" | "decreaseAllowance" | "eip712Domain" | "emergencyLastUnstakeTimestamp" | "freezeContract" | "gcaAndMinerPoolAddress" | "gcaAndMinerPoolLastClaimedTimestamp" | "gcaInflationData" | "glowUnlocker" | "grantsTreasuryAddress" | "grantsTreasuryInflationData" | "grantsTreasuryLastClaimedTimestamp" | "increaseAllowance" | "mint" | "name" | "nonces" | "numStaked" | "owner" | "permanentlyFreezeTransfers" | "permit" | "renounceOwnership" | "setContractAddresses" | "setGlowUnlocker" | "stake" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership" | "unstake" | "unstakedPositionsOf(address,uint256,uint256)" | "unstakedPositionsOf(address)" | "vetoCouncilAddress" | "vetoCouncilInflationData" | "vetoCouncilLastClaimedTimestamp"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "allowlistAddress", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "gcaAndMinerPoolAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "grantsTreasuryAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setContractAddresses", values: [string, string, string]): string;
    encodeFunctionData(functionFragment: "setGlowUnlocker", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "vetoCouncilAddress", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "allowlistAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "gcaAndMinerPoolAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "grantsTreasuryAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setGlowUnlocker", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "vetoCouncilAddress", data: BytesLike): Result;
...
export interface TestGLOW extends BaseContract {
    ...
    functions: {
        ...
        allowlistAddress(_address: string, overrides?: Overrides & {
        ...
        setContractAddresses(_gcaAndMinerPoolAddress: string, _vetoCouncilAddress: string, _grantsTreasuryAddress: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setGlowUnlocker(_glowUnlocker: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        accountUnstakedPositionPointers(account: string, overrides?: CallOverrides): Promise<IGlow.PointersStructOutput>;
        allowance(owner: string, spender: string, overrides?: CallOverrides): Promise<BigNumber>;
        allowlistAddress(_address: string, overrides?: CallOverrides): Promise<void>;
        allowlistedContracts(arg0: string, overrides?: CallOverrides): Promise<boolean>;
        ...
        setContractAddresses(_gcaAndMinerPoolAddress: string, _vetoCouncilAddress: string, _grantsTreasuryAddress: string, overrides?: CallOverrides): Promise<void>;
        setGlowUnlocker(_glowUnlocker: string, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        gcaAndMinerPoolAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        grantsTreasuryAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        vetoCouncilAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
