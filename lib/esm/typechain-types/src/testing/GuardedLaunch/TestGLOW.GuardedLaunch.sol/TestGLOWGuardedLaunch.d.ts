...
export interface TestGLOWGuardedLaunchInterface extends utils.Interface {
    functions: {
...
export interface TestGLOWGuardedLaunch extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestGLOWGuardedLaunchInterface;
