...
export interface GlowGuardedLaunchInterface extends utils.Interface {
    functions: {
...
export interface GlowGuardedLaunch extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GlowGuardedLaunchInterface;
