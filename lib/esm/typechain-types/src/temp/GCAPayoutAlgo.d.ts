...
export interface GCAPayoutAlgoInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addGCA" | "balance" | "claimRewards" | "editSeats" | "helpers" | "nextReward" | "nextRewardMockTimestamp" | "proposedCompensationPlans" | "removeGCA" | "rewardsPerSecondForAll" | "submitCompensationPlan" | "totalShares"): FunctionFragment;
...
export interface GCAPayoutAlgo extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GCAPayoutAlgoInterface;
