...
export interface HalfLifeCarbonCreditAuctionInterface extends utils.Interface {
    functions: {
...
export interface HalfLifeCarbonCreditAuction extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HalfLifeCarbonCreditAuctionInterface;
