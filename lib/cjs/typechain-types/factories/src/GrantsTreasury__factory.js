...
exports.GrantsTreasury__factory = void 0;
...
class GrantsTreasury__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.GrantsTreasury__factory = GrantsTreasury__factory;
