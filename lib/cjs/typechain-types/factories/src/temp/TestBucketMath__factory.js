...
exports.TestBucketMath__factory = void 0;
...
class TestBucketMath__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.TestBucketMath__factory = TestBucketMath__factory;
