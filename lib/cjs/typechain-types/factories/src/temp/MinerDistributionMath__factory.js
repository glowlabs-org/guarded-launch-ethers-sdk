...
exports.MinerDistributionMath__factory = void 0;
...
class MinerDistributionMath__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.MinerDistributionMath__factory = MinerDistributionMath__factory;
