...
exports.CarbonCreditAuction__factory = void 0;
...
class CarbonCreditAuction__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.CarbonCreditAuction__factory = CarbonCreditAuction__factory;
