...
export interface GCCGuardedLaunchInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "CARBON_CREDIT_AUCTION" | "COMMIT_PERMIT_TYPEHASH" | "GCA_AND_MINER_POOL_CONTRACT" | "GLOW" | "GOVERNANCE" | "IMPACT_CATALYST" | "UNISWAP_ROUTER" | "USDC" | "VETO_COUNCIL_ADDRESS" | "allowance" | "allowlistPostConstructionContracts" | "allowlistedContracts" | "approve" | "balanceOf" | "burn" | "burnFrom" | "commitAllowance" | "commitGCC(uint256,address,uint256)" | "commitGCC(uint256,address,address,uint256)" | "commitGCCFor(address,address,uint256,uint256)" | "commitGCCFor(address,address,uint256,address,uint256)" | "commitGCCForAuthorized(address,address,uint256,uint256,bytes,address,uint256)" | "commitGCCForAuthorized(address,address,uint256,uint256,bytes,uint256)" | "commitUSDC(uint256,address,uint256)" | "commitUSDC(uint256,address,address,uint256)" | "commitUSDCSignature" | "decimals" | "decreaseAllowance" | "decreaseAllowances" | "decreaseCommitAllowance" | "domainSeparatorV4" | "eip712Domain" | "freezeContract" | "increaseAllowance" | "increaseAllowances" | "increaseCommitAllowance" | "isBucketMinted" | "mintToCarbonCreditAuction" | "name" | "nextCommitNonce" | "permanentlyFreezeTransfers" | "setAllowances" | "symbol" | "totalImpactPowerEarned" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface GCCGuardedLaunch extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GCCGuardedLaunchInterface;
