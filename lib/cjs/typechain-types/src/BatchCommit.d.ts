...
export interface BatchCommitInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "GCC" | "USDC" | "commitGCC" | "commitUSDC"): FunctionFragment;
    encodeFunctionData(functionFragment: "GCC", values?: undefined): string;
    encodeFunctionData(functionFragment: "USDC", values?: undefined): string;
    encodeFunctionData(functionFragment: "commitGCC", values: [BigNumberish, string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "commitUSDC", values: [BigNumberish, string, BigNumberish, BytesLike]): string;
...
export interface BatchCommit extends BaseContract {
    ...
    functions: {
        ...
        commitGCC(amount: BigNumberish, rewardAddress: string, minImpactPower: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        commitUSDC(amount: BigNumberish, rewardAddress: string, minImpactPower: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    GCC(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        GCC(overrides?: CallOverrides): Promise<string>;
        USDC(overrides?: CallOverrides): Promise<string>;
        commitGCC(amount: BigNumberish, rewardAddress: string, minImpactPower: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        commitUSDC(amount: BigNumberish, rewardAddress: string, minImpactPower: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
