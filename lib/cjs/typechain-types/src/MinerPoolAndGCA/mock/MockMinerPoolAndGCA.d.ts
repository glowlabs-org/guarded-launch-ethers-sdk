...
export interface MockMinerPoolAndGCAInterface extends utils.Interface {
    functions: {
        ...
        "WCEIL(uint256)": FunctionFragment;
        ...
        "checkWeightsForOverflow(uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
        ...
        "currentWeekInternal()": FunctionFragment;
        "delayBucketFinalization(uint256)": FunctionFragment;
        "domainSeperatorOZ()": FunctionFragment;
        "domainSeperatorV4MainInternal()": FunctionFragment;
        ...
        "getPushedWeights(uint256)": FunctionFragment;
        "getUserBitmapForBucket(uint256,address)": FunctionFragment;
        "handleMintToCarbonCreditAuction(uint256)": FunctionFragment;
        "hasBucketBeenDelayed(uint256)": FunctionFragment;
        "incrementSlashNonce()": FunctionFragment;
        ...
        "pushRequirementsHashMock(bytes32)": FunctionFragment;
        "pushedWeights(uint256)": FunctionFragment;
        "requirementsHash()": FunctionFragment;
        "reward(uint256)": FunctionFragment;
        "setGCAs(address[])": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "CLAIM_PAYOUT_RELAY_PERMIT_TYPEHASH" | "GCC" | "GENESIS_TIMESTAMP" | "GLOW_REWARDS_PER_BUCKET" | "GLOW_TOKEN" | "GOVERNANCE" | "HOLDING_CONTRACT" | "OFFSET_LEFT" | "OFFSET_RIGHT" | "REWARDS_PER_SECOND_FOR_ALL" | "SHARES_REQUIRED_PER_COMP_PLAN" | "TOTAL_VESTING_PERIODS" | "USDC" | "WCEIL" | "allGcas" | "amountWithdrawnAtPaymentNonce" | "bucket" | "bucketClaimBitmap" | "bucketDelayDuration" | "bucketEndSubmissionTimestampNotReinstated" | "bucketFinalizationTimestampNotReinstated" | "bucketGlobalState" | "bucketStartSubmissionTimestampNotReinstated" | "checkWeightsForOverflow" | "claimGlowFromInflation" | "claimPayout" | "claimRewardFromBucket" | "createClaimRewardFromBucketDigest" | "createRelayDigest" | "currentBucket" | "currentWeekInternal" | "delayBucketFinalization" | "domainSeperatorOZ" | "domainSeperatorV4MainInternal" | "donateToUSDCMinerRewardsPool" | "donateToUSDCMinerRewardsPoolEarlyLiquidity" | "earlyLiquidity" | "eip712Domain" | "executeAgainstHash" | "gcaAgents" | "gcaPayoutData" | "getBucketTracker" | "getPayoutData" | "getProposalHashes(uint256,uint256)" | "getProposalHashes()" | "getPushedWeights" | "getUserBitmapForBucket" | "handleMintToCarbonCreditAuction" | "hasBucketBeenDelayed" | "incrementSlashNonce" | "isBucketFinalized" | "isGCA(address)" | "isGCA(address,uint256)" | "isSlashed" | "nextProposalIndexToUpdate" | "nextRelayNonce" | "paymentNonce" | "paymentNonceToCompensationPlan" | "paymentNonceToShiftStartTimestamp" | "payoutNonceToGCAHash" | "proposalHashes" | "pushHash" | "pushRequirementsHashMock" | "pushedWeights" | "requirementsHash" | "reward" | "setGCAs" | "setRequirementsHash" | "slashNonce" | "slashNonceToSlashTimestamp" | "submitCompensationPlan" | "submitWeeklyReport" | "submitWeeklyReportWithBytes"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "WCEIL", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "checkWeightsForOverflow", values: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "currentWeekInternal", values?: undefined): string;
    encodeFunctionData(functionFragment: "delayBucketFinalization", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "domainSeperatorOZ", values?: undefined): string;
    encodeFunctionData(functionFragment: "domainSeperatorV4MainInternal", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "getPushedWeights", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "getUserBitmapForBucket", values: [BigNumberish, string]): string;
    ...
    encodeFunctionData(functionFragment: "incrementSlashNonce", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "pushRequirementsHashMock", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "pushedWeights", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setGCAs", values: [string[]]): string;
    ...
    decodeFunctionResult(functionFragment: "WCEIL", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "checkWeightsForOverflow", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "currentWeekInternal", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "delayBucketFinalization", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "domainSeperatorOZ", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "domainSeperatorV4MainInternal", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getPushedWeights", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getUserBitmapForBucket", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "incrementSlashNonce", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "pushRequirementsHashMock", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "pushedWeights", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "requirementsHash", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "reward", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setGCAs", data: BytesLike): Result;
...
export interface MockMinerPoolAndGCA extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockMinerPoolAndGCAInterface;
    ...
    functions: {
        ...
        WCEIL(_slashNonce: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        checkWeightsForOverflow(bucketId: BigNumberish, totalGlwWeight: BigNumberish, totalUsdcWeight: BigNumberish, glwWeight: BigNumberish, usdcWeight: BigNumberish, overrides?: Overrides & {
        ...
        currentWeekInternal(overrides?: CallOverrides): Promise<[BigNumber]>;
        delayBucketFinalization(bucketId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        domainSeperatorOZ(overrides?: CallOverrides): Promise<[string]>;
        domainSeperatorV4MainInternal(overrides?: CallOverrides): Promise<[string]>;
        ...
        getPushedWeights(bucketId: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            glw: BigNumber;
            usdc: BigNumber;
        }>;
        getUserBitmapForBucket(bucketId: BigNumberish, user: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        incrementSlashNonce(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        pushRequirementsHashMock(hash: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        pushedWeights(bucketId: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        ...
        setGCAs(newGcas: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        bucketGlobalState(bucketId: BigNumberish, overrides?: CallOverrides): Promise<IGCA.BucketGlobalStateStructOutput>;
        bucketStartSubmissionTimestampNotReinstated(bucketId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        checkWeightsForOverflow(bucketId: BigNumberish, totalGlwWeight: BigNumberish, totalUsdcWeight: BigNumberish, glwWeight: BigNumberish, usdcWeight: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        hasBucketBeenDelayed(bucketId: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        incrementSlashNonce(overrides?: CallOverrides): Promise<void>;
        isBucketFinalized(bucketId: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        "isGCA(address)"(account: string, overrides?: CallOverrides): Promise<boolean>;
        "isGCA(address,uint256)"(account: string, index: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        isSlashed(arg0: string, overrides?: CallOverrides): Promise<boolean>;
        ...
        pushRequirementsHashMock(hash: BytesLike, overrides?: CallOverrides): Promise<void>;
        pushedWeights(bucketId: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        requirementsHash(overrides?: CallOverrides): Promise<string>;
        reward(id: BigNumberish, overrides?: CallOverrides): Promise<BucketSubmission.WeeklyRewardStructOutput>;
        setGCAs(newGcas: string[], overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        domainSeperatorOZ(overrides?: CallOverrides): Promise<BigNumber>;
        domainSeperatorV4MainInternal(overrides?: CallOverrides): Promise<BigNumber>;
        donateToUSDCMinerRewardsPool(amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        donateToUSDCMinerRewardsPoolEarlyLiquidity(amount: BigNumberish, overrides?: Overrides & {
        ...
        getPushedWeights(bucketId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getUserBitmapForBucket(bucketId: BigNumberish, user: string, overrides?: CallOverrides): Promise<BigNumber>;
        handleMintToCarbonCreditAuction(bucketId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        ...
        pushedWeights(bucketId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        WCEIL(_slashNonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        currentWeekInternal(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        delayBucketFinalization(bucketId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        domainSeperatorOZ(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        domainSeperatorV4MainInternal(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        donateToUSDCMinerRewardsPool(amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        donateToUSDCMinerRewardsPoolEarlyLiquidity(amount: BigNumberish, overrides?: Overrides & {
        ...
        getPushedWeights(bucketId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getUserBitmapForBucket(bucketId: BigNumberish, user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        handleMintToCarbonCreditAuction(bucketId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        ...
        pushedWeights(bucketId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
