...
export interface MockGCAInterface extends utils.Interface {
    functions: {
        ...
        "calculateBucketSubmissionEndTimestamp(uint256)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "CLAIM_PAYOUT_RELAY_PERMIT_TYPEHASH" | "GENESIS_TIMESTAMP" | "GLOW_TOKEN" | "GOVERNANCE" | "REWARDS_PER_SECOND_FOR_ALL" | "SHARES_REQUIRED_PER_COMP_PLAN" | "WCEIL" | "allGcas" | "amountWithdrawnAtPaymentNonce" | "bucket" | "bucketEndSubmissionTimestampNotReinstated" | "bucketFinalizationTimestampNotReinstated" | "bucketGlobalState" | "bucketStartSubmissionTimestampNotReinstated" | "calculateBucketSubmissionEndTimestamp" | "claimGlowFromInflation" | "claimPayout" | "createRelayDigest" | "currentWeekInternal" | "eip712Domain" | "executeAgainstHash" | "gcaAgents" | "gcaPayoutData" | "getPayoutData" | "getProposalHashes(uint256,uint256)" | "getProposalHashes()" | "incrementSlashNonce" | "isBucketFinalized" | "isGCA(address)" | "isGCA(address,uint256)" | "isSlashed" | "nextProposalIndexToUpdate" | "nextRelayNonce" | "paymentNonce" | "paymentNonceToCompensationPlan" | "paymentNonceToShiftStartTimestamp" | "payoutNonceToGCAHash" | "proposalHashes" | "pushHash" | "pushRequirementsHashMock" | "requirementsHash" | "setGCAs" | "setRequirementsHash" | "slashNonce" | "slashNonceToSlashTimestamp" | "submitCompensationPlan" | "submitWeeklyReport" | "submitWeeklyReportWithBytes"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "calculateBucketSubmissionEndTimestamp", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "calculateBucketSubmissionEndTimestamp", data: BytesLike): Result;
...
export interface MockGCA extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockGCAInterface;
    ...
    functions: {
        ...
        calculateBucketSubmissionEndTimestamp(id: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        calculateBucketSubmissionEndTimestamp(id: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        claimGlowFromInflation(overrides?: Overrides & {
            from?: string | Promise<string>;
