...
export interface GCASalaryHelperInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "CLAIM_PAYOUT_RELAY_PERMIT_TYPEHASH" | "REWARDS_PER_SECOND_FOR_ALL" | "SHARES_REQUIRED_PER_COMP_PLAN" | "amountWithdrawnAtPaymentNonce" | "claimPayout" | "createRelayDigest" | "getPayoutData" | "isSlashed" | "nextRelayNonce" | "paymentNonce" | "paymentNonceToCompensationPlan" | "paymentNonceToShiftStartTimestamp" | "payoutNonceToGCAHash"): FunctionFragment;
...
export interface GCASalaryHelper extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GCASalaryHelperInterface;
