...
export interface GlowInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "DOMAIN_SEPARATOR" | "EARLY_LIQUIDITY_ADDRESS" | "EMERGENCY_COOLDOWN_PERIOD" | "GCA_AND_MINER_POOL_ADDRESS" | "GCA_AND_MINER_POOL_INFLATION_PER_SECOND" | "GENESIS_TIMESTAMP" | "GRANTS_TREASURY_ADDRESS" | "GRANTS_TREASURY_INFLATION_PER_SECOND" | "MAX_UNSTAKES_BEFORE_EMERGENCY_COOLDOWN" | "VETO_COUNCIL_ADDRESS" | "VETO_COUNCIL_INFLATION_PER_SECOND" | "accountUnstakedPositionPointers" | "allowance" | "approve" | "balanceOf" | "claimGLWFromGCAAndMinerPool" | "claimGLWFromGrantsTreasury" | "claimGLWFromVetoCouncil" | "claimUnstakedTokens" | "decimals" | "decreaseAllowance" | "eip712Domain" | "emergencyLastUnstakeTimestamp" | "gcaAndMinerPoolLastClaimedTimestamp" | "gcaInflationData" | "grantsTreasuryInflationData" | "grantsTreasuryLastClaimedTimestamp" | "increaseAllowance" | "name" | "nonces" | "numStaked" | "permit" | "stake" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "unstake" | "unstakedPositionsOf(address,uint256,uint256)" | "unstakedPositionsOf(address)" | "vetoCouncilInflationData" | "vetoCouncilLastClaimedTimestamp"): FunctionFragment;
...
export interface Glow extends BaseContract {
