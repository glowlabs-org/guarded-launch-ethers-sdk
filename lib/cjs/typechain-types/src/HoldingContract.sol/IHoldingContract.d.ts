...
export interface IHoldingContractInterface extends utils.Interface {
    functions: {
...
export interface IHoldingContract extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IHoldingContractInterface;
    ...
    filters: {
        "NetworkDelay(address,uint256)"(vetoAgent?: null, timestampOfDelay?: null): NetworkDelayEventFilter;
        NetworkDelay(vetoAgent?: null, timestampOfDelay?: null): NetworkDelayEventFilter;
    };
    estimateGas: {
        addHolding(user: string, token: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
