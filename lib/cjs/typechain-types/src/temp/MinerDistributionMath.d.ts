...
export interface MinerDistributionMathInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "BUCKET_DURATION" | "GENESIS_TIMESTAMP" | "OFFSET_LEFT" | "OFFSET_RIGHT" | "TOTAL_VESTING_PERIODS" | "addToCurrentBucket" | "currentBucket" | "getRewards" | "lastUpdatedBucket" | "reward" | "rewards"): FunctionFragment;
    encodeFunctionData(functionFragment: "BUCKET_DURATION", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "getRewards", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "lastUpdatedBucket", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "BUCKET_DURATION", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "lastUpdatedBucket", data: BytesLike): Result;
...
export interface MinerDistributionMath extends BaseContract {
    ...
    functions: {
        ...
        getRewards(start: BigNumberish, end: BigNumberish, overrides?: CallOverrides): Promise<[MinerDistributionMath.WeeklyRewardStructOutput[]]>;
        lastUpdatedBucket(overrides?: CallOverrides): Promise<[BigNumber]>;
        reward(id: BigNumberish, overrides?: CallOverrides): Promise<[MinerDistributionMath.WeeklyRewardStructOutput]>;
    ...
    estimateGas: {
        ...
        currentBucket(overrides?: CallOverrides): Promise<BigNumber>;
        getRewards(start: BigNumberish, end: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        lastUpdatedBucket(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getRewards(start: BigNumberish, end: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
