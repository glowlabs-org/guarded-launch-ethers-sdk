...
export interface TestGCCGuardedLaunchInterface extends utils.Interface {
    functions: {
...
export interface TestGCCGuardedLaunch extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestGCCGuardedLaunchInterface;
