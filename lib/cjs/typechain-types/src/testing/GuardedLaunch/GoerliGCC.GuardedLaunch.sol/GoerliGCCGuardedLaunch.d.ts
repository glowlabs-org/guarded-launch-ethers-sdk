...
export interface GoerliGCCGuardedLaunchInterface extends utils.Interface {
    functions: {
        ...
        "allowlistPostConstructionContracts()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "CARBON_CREDIT_AUCTION" | "COMMIT_PERMIT_TYPEHASH" | "GCA_AND_MINER_POOL_CONTRACT" | "GLOW" | "GOVERNANCE" | "IMPACT_CATALYST" | "UNISWAP_ROUTER" | "USDC" | "VETO_COUNCIL_ADDRESS" | "allowance" | "allowlistAddress" | "allowlistPostConstructionContracts" | "allowlistedContracts" | "approve" | "balanceOf" | "burn" | "burnFrom" | "commitAllowance" | "commitGCC(uint256,address,uint256)" | "commitGCC(uint256,address,address,uint256)" | "commitGCCFor(address,address,uint256,uint256)" | "commitGCCFor(address,address,uint256,address,uint256)" | "commitGCCForAuthorized(address,address,uint256,uint256,bytes,address,uint256)" | "commitGCCForAuthorized(address,address,uint256,uint256,bytes,uint256)" | "commitUSDC(uint256,address,uint256)" | "commitUSDC(uint256,address,address,uint256)" | "commitUSDCSignature" | "decimals" | "decreaseAllowance" | "decreaseAllowances" | "decreaseCommitAllowance" | "domainSeparatorV4" | "eip712Domain" | "freezeContract" | "increaseAllowance" | "increaseAllowances" | "increaseCommitAllowance" | "isBucketMinted" | "mint" | "mintToCarbonCreditAuction" | "name" | "nextCommitNonce" | "permanentlyFreezeTransfers" | "setAllowances" | "symbol" | "totalImpactPowerEarned" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "allowlistPostConstructionContracts", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "allowlistPostConstructionContracts", data: BytesLike): Result;
...
export interface GoerliGCCGuardedLaunch extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GoerliGCCGuardedLaunchInterface;
    ...
    functions: {
        ...
        allowlistPostConstructionContracts(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        allowlistPostConstructionContracts(overrides?: CallOverrides): Promise<void>;
        allowlistedContracts(arg0: string, overrides?: CallOverrides): Promise<boolean>;
