...
export interface CarbonCreditDescendingPriceAuctionInterface extends utils.Interface {
    functions: {
...
export interface CarbonCreditDescendingPriceAuction extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CarbonCreditDescendingPriceAuctionInterface;
